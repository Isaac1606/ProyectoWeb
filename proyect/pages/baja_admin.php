...
<?php
    ...
    $sql = "select imagen,id_usuario,genero,fecha_nacimiento,fecha_registro from usuario where tipo='admin'";
    ...
    while($row=mysqli_fetch_array($res)){
        ...
        echo "<a href='accion_admi6?usuario=$row[1]'> Descender admin </a><br>";
