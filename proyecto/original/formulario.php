                ...
                <div class="form-row align-items-center">
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-5 col-xl-5 mt-sm-3 mb-sm-3 mt-3 mb-3">
                        <div class="custom-file">
                            ...
                            <label class="custom-file-label text-truncate" for="imagen">Elige tu foto de
                                perfil...</label>
...
<!--                        <p id="" class="form-text text-muted text-right">-->
<!--                            &lt;!&ndash;Texto para dar indicaciones se puede trabajar en conjunto a javascript&ndash;&gt;-->
