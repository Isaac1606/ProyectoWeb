                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item dropdown">
                            <a href="" class="nav-link dropdown-toggle" id="menu-categorias" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Mas popular</a>
                            <div class="dropdown-menu bg-dark" aria-labelledby="menu-categorias">
                                <a href="#" class="dropdown-item text-secondary">Por Imagen</a>
                                <a href="#" class="dropdown-item text-secondary">Por Categoria</a>
                            </div>
                        </li>
                    </ul>
                    <li class="nav-item">
...
if(isset($_SESSION['usuario'])){
        ...
        <li class="nav-item dropdown">
            <a href="" class="nav-link dropdown-toggle" id="menu-categorias" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Mi perfil</a>
                <div class="dropdown-menu bg-dark" aria-labelledby="menu-categorias">
                    <a href="actualiza_datos.php" class="dropdown-item text-secondary">Actualizar Datos</a>
