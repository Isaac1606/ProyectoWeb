<?php
    ...
    $destMail = 'tutsipophot@gmail.com';
    $destName = 'TestDummy';
    $dedica = 'MUERETE';
    ...
    try {
        ...
        //$mail->addAttachment(base64_decode($img), $imgName.'.jpg');    // Optional name
        ...
        $body = "<h1 style='text-align: center; font-family: cambria;'>$usernick te ha enviado una postal a trav&eacute;s de <strong><span style='color: #0000ff;'><span style='color: #3949ab;'>$webName</span></span></strong>!</h1>
                  <p style='text-align: left;'>Hola $destName, has recibido una nueva postal de $username con la siguiente dedicatoria:</p>
        ...
        header('Location: imagenes.php');//CAMBIAR AQUI PLANTILLA
    } catch (Exception $e) {
